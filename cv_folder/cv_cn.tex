...
(* 表示通讯作者，$^\dagger$ 表示共同贡献。)
  ...
  \resumeProjectHeading{\textbf{期刊文章}}{}
      \resumeItemListStart
        \resumeItem{\textbf{Zeng, H.}, Zhong, W., \& Xu, X. (2024). ``Transfer Learning for Spatial Autoregressive Models with Application to U.S. Presidential Election Prediction.'' (已接收，\textit{\textbf{Journal of Business \& Economic Statistics}})} 
