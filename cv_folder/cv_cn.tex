...
(* 表示通讯作者，$^\dagger$ 表示共同贡献。)
  ...
  \resumeProjectHeading{\textbf{期刊文章}}{}
    ...
    \begin{etaremune}
        ...
        \resumeItem{Liu, K., \textbf{Zeng, H.}, Huang, J., Zhuang, H., Vong, C.-M., \& Wei, H. (2025). ``C-Adapter: Adapting Deep Classifiers for Efficient C onformal Prediction Sets.'' \textit{\textbf{28th European Conference on Artificial Intelligence}}.}
    \end{etaremune}
    % \newpage
