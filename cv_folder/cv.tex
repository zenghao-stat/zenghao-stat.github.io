...
\resumeItemListStart
  ...
  \resumeItem{Huajun Xi, Kangdao Liu, \textbf{Hao Zeng}, Wenguang Sun, \& Hongxin Wei (2025). ``Exploring the Noise Robustness of Online Conformal Prediction.'' \textit{\textbf{39th Annual Conference on Neural Information Processing Systems}}. (AI Top conference)
  }
...
\resumeItemListEnd
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
      \resumeItem{Jingyi Zhang, Yang Yue, Wei Zhong, \& \textbf{Hao Zeng*} (2025). ``Robust Estimation of Grouped Network Vector Autoregression: An Empirical Analysis Based on China Air Quality Data.'' (Submitted to \textit{Statistical Research})}
        \resumeItem{Huipeng Huang, Wenbo Liao, Huajun Xi, \textbf{Hao Zeng}, Mengchen Zhao, \& Hongxin Wei (2025). ``Selective Labeling with False Discovery Rate Control.'' (Submitted to ICLR 2026)}
        \resumeItem{Zhenlong Liu, \textbf{Hao Zeng}, Weiran Huang, \& Hongxin Wei (2025). ``High-Power Training Data Identification with Provable Statistical Guarantees.'' (Submitted to ICLR 2026)}
        \resumeItem{\textbf{Hao Zeng}$^\dagger$, Jianguo Huang$^\dagger$, Bingyi Jing, Hongxin Wei, \& Bo An (2025). ``PAC Reasoning: Controlling the Performance Loss for Efficient Reasoning.'' (Submitted to ICLR 2026)}
        ...
        \resumeItem{Xuanning Zhou, \textbf{Hao Zeng}, Xiaobo Xia, Bingyi Jing, \& Hongxin Wei (2025). ``Semi-Supervised Conformal Prediction with Unlabeled Nonconformity Score.'' arXiv. (Submitted to CVPR 2026)}
        ...
        \resumeItem{\textbf{Hao Zeng}, \& Jianguo Huang (2025). ``PAC Accelerate: A Statistically Guaranteed Acceleration Method for Large Generative Models.''}
        \resumeItem{\textbf{Hao Zeng}, \& Jianguo Huang (2025). ``Group-Conditional PAC Reasoning: Groupwise Efficient Reasoning with Statistical Guarantees.''}
        \resumeItem{\textbf{Hao Zeng}, Jiajun Sun, Bingyi Jing, \& Wei Zhong (2025). ``Test-time Valid Selection of Conformal Sets via Gaussian Stability.'' Working paper.}
        \resumeItem{\textbf{Hao Zeng}, Junxian Liu, Bingyi Jing, \& Hongxin Wei (2025). ``Efficient Backward Conformal Prediction.'' Working paper.}
      \resumeItemListEnd
