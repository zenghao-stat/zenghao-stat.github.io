...
\resumeItemListStart
  ...
  \resumeItem{Xi, H., Liu, K., \textbf{Zeng, H.}, Sun, W., \& Wei, H. (2025). ``Exploring the Noise Robustness of Online Conformal Prediction.'' \textit{\textbf{39th Annual Conference on Neural Information Processing Systems}}. (AI Top conference)
  }
...
\resumeItemListEnd
    ...
    \resumeProjectHeading
      ...
      \resumeItem{Zhang, J., Yue, Y., Zhong, W., \& \textbf{Zeng, H.*} (2025). ``Robust Estimation of Grouped Network Vector Autoregression: An Empirical Analysis Based on China Air Quality Data.'' (Submitted to \textit{Statistical Research})}
        ...
        \resumeItem{\textbf{Zeng, H.}, Sun, J., Jing, B., \& Zhong, W. (2025). ``Test-time Valid Selection of Conformal Sets via Gaussian Stability.'' Working paper.}
        \resumeItem{\textbf{Zeng, H.}, Liu, J., Jing, B., \& Wei, H. (2025). ``Efficient Backward Conformal Prediction.'' Working paper.}
      \resumeItemListEnd
