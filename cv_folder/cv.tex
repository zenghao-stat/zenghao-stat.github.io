...
\resumeItemListStart
  ...
  \resumeItem{Kangdao Liu, Tianhao Sun, \textbf{Hao Zeng}, Yongshan Zhang, Chi-Man Pun, \& Chi-Man Vong (2025). ``Spatial-Aware Conformal Prediction for Trustworthy Hyperspectral Image Classification.'' \textit{\textbf{IEEE Transactions on Circuits and Systems for Video Technology}} 35 (9): 8754–8766. (CAS Q1 journal, Top)}
  \resumeItem{\textbf{Hao Zeng}, Chuang Wan, Wei Zhong, \& Tuo Liu (2024). ``Robust Integrative Analysis via Quantile Regression with Homogeneity and Sparsity.'' \textit{\textbf{Journal of Statistical Planning and Inference}} 234 (January): 106196.}
  \resumeItem{Chuang Wan$^\dagger$, \textbf{Hao Zeng$^\dagger$*}, Wenyang Zhang$^\dagger$, Wei Zhong$^\dagger$, \& Changliang Zou$^\dagger$ (2024). ``Data‐driven Estimation for Multithreshold Accelerated Failure Time Model.'' \textit{\textbf{Scandinavian Journal of Statistics}} 52 (1): 447–468.}
